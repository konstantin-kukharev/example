...
func (m Comment) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.NewComment)
	if err != nil {
		return nil, err
	}
...
func (m *Comment) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with NewComment
	if err := m.NewComment.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Comment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with NewComment
	if err := m.NewComment.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
