...
//
// To ensure default values, the struct must have been initialized with NewAddCommentParams() beforehand.
func (o *AddCommentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
